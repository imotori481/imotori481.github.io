const quiz = [
    ...
    { 
        ...
        choices: ['カンスト時にグレードS9', 'カンスト時に8分45秒以下', 'Lv0～500で、セクションタイムが1分5秒以下', 'Lv500～999で、セクションタイムが前セクション+2秒以下'], 
        correct: 'Lv500～999で、セクションタイムが前セクション+2秒以下' 
    },
    { 
        question: 'Q10 Tiにおいて、Lv100以降セクションCOOLは、基本的に前セクションタイム+何秒以内で取れる？', 
        choices: ['1', '2', '3', '4'], 
        correct: '2' 
    },
    { 
